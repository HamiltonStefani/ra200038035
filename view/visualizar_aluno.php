  ...
  <main class="d-flex container align-items-center" style="height: calc(100vh - 56px); ">
    <div class="container-fluid border rounded p-5" style="box-shadow: 1px 2px 6px 4px rgba(0,0,0,0.1)">
      ...
      <div class="row mt-5">
        ...
        <div class="col-md-3">
          <p class="font-weight-bold">Status: se (1) Ativo se (0) Inativo</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-3">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <p><?php if($array2) {echo $array2[0]->getNameCourse();} else {echo "Curso inexistente";};?></p>
        </div>
        <div class="col-md-3">
