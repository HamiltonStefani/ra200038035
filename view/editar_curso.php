...
<?php include_once './header.php'?>
  ...
  <main class="d-flex container align-items-center" style="height: calc(100vh - 56px); ">
    ...
    <a type="button" href="./cursos.php" class="btn btn-primary">Voltar</button></a>
      ...
      <form action="../controllers/editar_curso_action.php" method="POST" class="mt-5">
        ...
        <div class="row">
        <div class="col-md-7">
            <input type="text" style="display: nome;" class="form-control" name="id" id="id" aria-describedby="id" value="<?=$course[0]->getId();?>">
          </div>
          <div class="col-md-7">
          ...
          <div class="col-md-5">
            <select class="form-control" aria-label="Selecione" name="status">
              <option value="1"<?php if($course[0]->getId()== 1) echo 'selected';?>>Ativo</option>
              <option value="0"<?php if($course[0]->getId()== 0) echo 'selected';?>>Inativo</option>
            </select>
          </div>
        </div>
        <div class="row mt-4">
        ...
        <div class="row mb-5">
          <div class="col-md-12"><textarea style="resize: none;height: 100px;" class="form-control" name="description" id="description"
           aria-describedby="description"><?=$course[0]->getDescription();?></textarea></div>
        </div>
